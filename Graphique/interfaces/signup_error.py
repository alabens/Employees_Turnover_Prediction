...
"padding: 10px 15px;")
        ...
        self.commandLinkButton.clicked.connect(Ui_SignupError.on_click_Signin)
...
"padding: 10px 15px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "Company name must be not already used"))
        ...
        self.lineEdit_3.setPlaceholderText(_translate("MainWindow", "Your mail must be not already used"))
